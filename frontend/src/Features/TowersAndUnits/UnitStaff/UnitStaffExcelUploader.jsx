...
const UnitStaffExcelUploader = ({ onUploadSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log("✅ Unit Staff upload success response:", response.data);
      console.log("✅ Normalized data for modal:", normalizedData);

      enqueueSnackbar(response.data.message || "Upload successful", {
      ...
      if (response.data.status === "success") {
        window.dispatchEvent(new Event('unitStaffBulkUploadCompleted'));
      }
    } catch (error) {
      let message = "Upload failed. Please try again.";
      console.log("jlgjglkwglkmwelk", error);
      
      // Check for timeout specifically
      if (error.code === 'ECONNABORTED' || error.message?.includes('timeout')) {
        message = "Upload is taking longer than expected. The process may still be running on the server. Please wait a moment and check if the data was imported.";
        setResults({
          total_rows: 0,
          success_count: 0,
          error_count: 1,
        ...
        // Backend now returns data directly with failed_rows instead of errors
        const normalizedErrors = (data.failed_rows || []).map((err) => ({
          row: err.row || "N/A",
          errors: err.errors || {},  // Keep as object for proper display
          data: err.data || {}
        }));
        ...
        const errorResults = {
          ...
          error_count: data.error_count || normalizedErrors.length || 1,
          errors: normalizedErrors
        };
        
        console.log("📦 Setting results to:", errorResults);
      ...
      console.log("🔄 Unit Staff finally block - finishing up");
      setUploading(false);
    }
  };
  ...
  const handleDownloadSampleData = () => {
    const templateData = [
      {
        ...
        unit_name: 201,
        full_name: "",
        general_contact: "01887876546",
        delivery_method: "",
        general_email: "residant1@gmail.com",
        nid_number: "",
        unit_staff_status: 1,
        permanent_address: "bca",
        present_address: "abc",
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Unit Staff Sample");
    XLSX.writeFile(wb, "unit_staff_sample.xlsx", { compression: true });
  };
    ...
    <div className="h-full overflow-y-auto">
      <div className="px-6 py-4">
        ...
        {showInstructions && (
          <div className="bg-subprimary border border-primary rounded-lg p-4 mb-6">
            ...
            {/* <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
              ...
              <li>
                For staff_type column: use 0 = Part-time, 1 = Live-in staf
              </li>
            </ul> */}
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
              ...
              <li>
                Fill required fields: unit_name, tower_name, tower_number, full_name,
                general_contact,general_email
              </li>
              <li>
        ...
        {/* <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center mb-6">
          ...
          {file && (
            <div className="flex items-center bg-gray-100 rounded-lg px-4 py-2 mt-2 justify-center">
        ...
        <div className="flex gap-4 mb-6">
          <button
            ...
            className={`flex-1 py-3 px-4 bg-secondary  text-white rounded-lg font-medium flex items-center justify-center ${
              !file || uploading
...
export default UnitStaffExcelUploader;
