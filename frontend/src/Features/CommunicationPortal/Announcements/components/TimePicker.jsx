...
const TimePicker = ({ value, onChange, placeholder = "Select Time" }) => {
  ...
  return (
    <div className="relative" ref={timePickerRef}>
      ...
      <div
        ref={inputRef}
        className="w-full min-w-[140px] h-[38px] px-3 border border-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-white cursor-pointer flex items-center justify-between"
