...
const EditPaymentMethodModal = ({ isOpen, onClose, method, onUpdated }) => {
  ...
  useEffect(() => {
    if (method) {
      setFormData({
        ...
        method_type: method.method_type || "mfs",
      ...
      <div className="relative bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-zoomIn max-h-[95vh] md:max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-500 font-semibold text-wrap truncate max-w-[300px]">
              Update settings for {method?.method_name}
            </p>
          </div>
          <button
            onClick={onClose}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  {[
                    ...
                    { value: "bank", icon: FaBuilding, label: "Bank" },
                    { value: "mfs", icon: FaWallet, label: "MFS" },
