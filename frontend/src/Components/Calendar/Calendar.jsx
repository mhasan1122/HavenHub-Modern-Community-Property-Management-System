...
const Calendar = ({ value, onChange, placeholder = "Select Date" }) => {
  ...
  return (
    <div className="relative w-full" ref={calendarRef}>
      ...
      <div
        ref={inputRef}
        className={`login-field-input cursor-pointer !flex items-center justify-between ${isOpen ? '!border-primary !bg-white !shadow-ring-primary' : ''}`}
        onClick={() => setIsOpen(!isOpen)}
      >
        <span className={`flex-1 ${selectedDate ? 'text-black text-sm' : 'text-gray-400 text-sm'}`}>
