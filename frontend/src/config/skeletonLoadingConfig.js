 ...
 * 
 * Controls the minimum display time for skeleton loaders.
 ...
 *   const showSkeleton = useSkeletonLoading(loading, data, SKELETON_MIN_DISPLAY_TIME);
 */
...
export const SKELETON_MIN_DISPLAY_TIME = 100;

// Alternative: Use environment variable (uncomment to use)
// export const SKELETON_MIN_DISPLAY_TIME = 
//   process.env.REACT_APP_SKELETON_MIN_DISPLAY_TIME 
//     ? parseInt(process.env.REACT_APP_SKELETON_MIN_DISPLAY_TIME, 10) 
//     : 0;
