...
export const ENVIRONMENT = {
  ...
  DEV: {
    BACKEND_URL: 'http://192.168.0.219:8000', // Network IP for physical devices - localhost won't work on physical devices
  ...
  LOCAL: {
    BACKEND_URL: 'https://api.estatelink.cloud', // Android emulator uses 10.0.2.2 for host machine
    API_TIMEOUT: 5000,
    RETRY_ATTEMPTS: 2,
    RETRY_DELAY: 500,
    AUTO_DISCOVERY: true,
...
export const getFallbackURLs = (): string[] => {
  return [
    'https://api.estatelink.cloud',
    'http://192.168.0.219:8000',// Network IP (physical device) - PRIMARY
